...
class DataPrep:
    ...
    root = pathlib.Path('/dataHDD/chsaikeerthi/2024-chirumamilla/ddata/TIMIT')
    README = (root / 'README.DOC').read_text()

    dataset = jbof.create_dataset('/dataHDD/chsaikeerthi/2024-chirumamilla/ddata/TIMIT_new1', {'README': README})

    sentences = {}
    for line in (root / '/dataHDD/chsaikeerthi/2024-chirumamilla/ddata/TIMIT/DOC/PROMPTS.TXT').open():
    ...
    for line in (root/'/DOC/SPKRINFO.TXT').open():
        if line.startswith(';'): continue
...
if __name__ == '__main__':
    ...
    data_prep = DataPrep('ddata/TIMIT_orig', '/dataHDD/chsaikeerthi/2024-chirumamilla/data/TIMIT_mine')
